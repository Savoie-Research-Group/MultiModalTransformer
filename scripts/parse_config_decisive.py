...
def parse_config(args):
    if os.path.isfile(args.config) is False:
        ...
        exit()
    keywords = ['src_test','tgt_test','null_src_test','null_tgt_test','mode_lst','best_chk_path','ch_to_idx_dict_path','idx_to_ch_dict_path','mol_path','r_path','ms_path','ir_path','nmr_path']
